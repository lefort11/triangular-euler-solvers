#ifndef TRIANGULAR_SOLVERS_HLLC_H
#define TRIANGULAR_SOLVERS_HLLC_H
...
namespace euler
{
	...
	class HLLC:public Solver
	{

	public:

		explicit HLLC(std::vector<Zone> const& constraints,
	...
	protected:
		...
		/**@brief Calculates an HLLC numerical flux
		 *
...
#endif //TRIANGULAR_SOLVERS_HLLC_H
